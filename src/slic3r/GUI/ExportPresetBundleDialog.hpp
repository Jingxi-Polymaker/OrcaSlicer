    ...
    namespace GUI {
        ...
        class ExportPresetBundleDialog : public Slic3r::GUI::DPIDialog
        {
            ...
            protected:
                ...
                std::unordered_map<std::string, std::vector<const Preset *>> m_filament_presets;//first: printer name, second: filament presets have same printer name
                std::unordered_map<std::string, std::vector<const Preset *>> m_process_presets;//first: printer name, second: filament presets have same printer name
