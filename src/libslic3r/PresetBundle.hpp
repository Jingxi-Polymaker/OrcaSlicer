...
public:
    ...
    PresetsConfigSubstitutions import_subscribed_presets(AppConfig &config, std::map<std::string, std::map<std::string, std::map<std::string, std::string>>>& bundle_presets, ForwardCompatibilitySubstitutionRule rule);
